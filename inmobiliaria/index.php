...
<html>
    <head>
        ...
        <title>SIAI | Inmobiliaria</title>
        <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
        <meta name="description" content="Servicios Integrales de Administracion Inmobiliaria tambien se dedica al alquiler, venta, antidretico, Preventa de todo tipo de inmueble en La Paz Bolivia.">
    ...
    <body>
        <div class="container">
            ...
            <div class="row text-center">
                <div class="col-md-3"><a href="venta/" class="boton">Venta</a></div>
                <div class="col-md-3"><a href="alquiler/" class="boton">Alquiler</a></div>
                <div class="col-md-3"><a href="anticretico/" class="boton">Anticretico</a></div>
                <div class="col-md-3"><a href="pre_venta" class="boton">Pre Venta</a></div>
            </div>
            <!-- <footer style="background-color: white; color: blue; border-radius: 25px; margin-bottom: 20px;">
                <div class="hidden-xs">

...
?>
    <div class="container"> 
        <h4 style="color: white; text-align: center;">Registro de Inmueble en Anticretico</h4>       
        <form action="agregar_inmueble_anticretico.php" method="POST" enctype="multipart/form-data" id="filesForm">
            <input type="hidden" value="<?=$_SESSION['id_agente_venta']?>" name="id_agente_venta">
            <input type="hidden" value="anticretico" name="tipo">
            ...
            <input type="number" class="form-control" name="matraje" required>
            <br>

...
<html>
    <head>
        ...
        <title><?=$_GET['inmueble']?> en Anticretico | SIAI Srl.</title>
        <meta property="og:image" content="http://siai.com.bo/img/inicio/icono.png">
        <meta property="og:title" content="<?=$_GET['inmueble']?> en Anticretico | SIAI Srl.">
    ...
    <style>
      ...
      <div id="panel">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <button class="open1"><a href="<?php if($inmueble == 'Oficina'){echo "listaOficinas.php";}else if($inmueble == 'Departamento'){echo "listaDepartamento.php";}else if($inmueble == 'Casa'){echo "listaCasas.php";}else{echo "listaLocalComercial.php";}?>"><i class="fa fa-arrow-left" aria-hidden="true"></i></a></button>
                </div>
            </div>
        </div>
    <body id="">
            ...
            <?php
                ...
                // while($i <= $numero){
                    $consultaInterna = "SELECT * 
                                        ...
                                        WHERE inmueble = '$inmueble' AND anticretico_id_anticretico = $idimueble";

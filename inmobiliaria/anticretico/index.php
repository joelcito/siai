        ...
        <div class="container">
            ...
            <div class="row">
                <!-- <div class="col-md-1"></div> -->
                    ...
                    <div class="col-md-3"><a href="listaDepartamento.php" class="boton">Departamento</a></div>
                    <div class="col-md-3"><a href="listaCasas.php" class="boton">Casa</a></div>
                    <div class="col-md-3"><a href="listaLocalComercial.php" class="boton">Local Comercial</a></div>
                <!-- <div class="col-md-1"></div> -->
            </div>
            <!-- <footer>
                <div class="row">

        ...
        <div class="container">
            ...
            if(isset($_GET['buton'])){
                if(!empty($_GET['zona']) || !(empty($_GET['desde']) && empty($_GET['hasta'])) || !(empty($_GET['minimo']) && empty($_GET['maximo']))){
                    ...
                    // }
                    $query.="AND inmueble = 'Oficina'";
                    $query2.="AND inmueble = 'Oficina'";
                    ...
                    if($numeroBusqueda != 0){
                        ...
                        while($i <= $numeroBusqueda){
                            ...
                            $query2 = $paso1;
                            if($numeroFotos != 0){
                                // echo "Query 1: ".$query."<br>Query2: ".$query2;
                            ?>
                            <!-- principio -->
                            <div class="row">
                ...
                ?>
                    <div style="background-color: white; border-radius: 25px;opacity: 0.8;">
                        <img src="../../img/inicio/sinAlquiler.png" alt="">
                    </div>
                <?php
                    }
                }
                ...
                ?>
                    <div class="alert alert-warning alert-dismissible">
                        ...
                        <br>
                        <strong>Seleccione!</strong> un campo al menos del formulario de FILTRO.
                    </div>
            <?php
                }
            }
                ...
                while($i <= $numero){
                    $consultaInterna = "SELECT * 
                                        FROM inmueble_alquiler iv INNER JOIN foto_alquiler ft
                                            ON (iv.id_alquiler = ft.alquiler_id_alquiler) INNER JOIN agente_venta av
                                                ON iv.agente_venta_id_agente_venta = av.id_agente_venta
                                        WHERE inmueble = 'Oficina' AND alquiler_id_alquiler = $contador";
                        ...
                        <div class="col-md-4 kol" style=" background-color: white; opacity: 0.7; color: black; margin-top: 0;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" style="float: none;">
                                    <div class="row">
                                        <div class="col-md-6" style="float: left;">
                                            <a href="#" class="boton1"><i class="fa fa-youtube-play" aria-hidden="true"></i> You Tube</a>                                            
                                        </div>
                                        <div class="col-md-6">
                                            <a class="boton" target="_block" href="https://api.whatsapp.com/send?phone=591<?=$mostrar['celular'];?>&text=Estoy%20interesado%20en%20el%20inmueble,%20por%20favor%20podría%20ampliar%20algo%20mas%20de%20de%20informacion?">
                                                <i class="fa fa-whatsapp" aria-hidden="true"></i> WhatsApp
                                            </a>
                                        </div>
                                    </div>

...
<html>
    <head>
        ...
        <title><?=$_GET['inmueble']?> en Alquiler | SIAI Srl.</title>
        <meta content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no" name="viewport">
        <meta property="og:image" content="http://siai.com.bo/img/inicio/icono.png">
        <meta property="og:title" content="<?=$_GET['inmueble']?> en Alquiler | SIAI Srl.">
        <meta property="og:description" content="Servicios Integrales de Administracion Inmobiliaria tambien se dedica al alquiler, venta, antidretico, Preventa de todo tipo de inmueble en La Paz Bolivia.">
        <meta property="og:url" content="http://siai.com.bo">
    ...
    <style>
      ...
      <div id="panel">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <button class="open1"><a href="<?php if($inmueble == 'Oficina'){echo "listaOficinas.php";}else if($inmueble == 'Departamento'){echo "listaDepartamentos.php";}else if($inmueble == 'Casa'){echo "listaCasas.php";}else{echo "listaLocalComerciales.php";}?>"><i class="fa fa-arrow-left" aria-hidden="true"></i></a></button>
                </div>
            </div>
        </div>
    <body id="">
            ...
            // $conexion = new mysqli("localhost","root","","mydb");
                ...
                // while($i <= $numero){
                    $consultaInterna = "SELECT * 
                                        ...
                                        WHERE inmueble = '$inmueble' AND alquiler_id_alquiler = $idimueble";
                ...
                <br><br>
                    <div class="row tiempo"  style="border-style: inset; border-color: burlywood; margin-left: 0;margin-right: 0;">
                        ...
                        <div class="col-md-4 kol" style=" background-color: white; opacity: 0.7; color: black; margin-top: 0;">
                            ...
                            <p id="mi_parrafo<?php echo $i?>" class="hidden">
                                https://siai.com.bo/inmobiliaria/alquiler/listaOficinas.php#iner<?php echo $i?>
                            </p>
                            <!-- <center><button onclick="copiarAlPortapapeles('mi_parrafo<?php echo $i?>')" class="boton2">Copiar Link del Inmueble</button></center> -->
                            <!-- <center><a href="mostrar.php?id=<?php //echo $mostrar['id_alquiler'];?>" class="boton2">Ver Inmueble</a></center> -->

                        ...
                        <!-- filtro de busqueda -->
                            <div class="row" >
                                <div class="col-md-12">
                                    ...
                                    ?>
                                    <!-- <input type="text" name="valor-para-ocultar" id="valor-para-ocultar" value="1"> -->
                                </div>
                                <!-- <div class="col-md-4">
                                    <h4>Metraje</h4>
        ...
        <div class="container">
            ...
            if(isset($_GET['buton'])){
                if(!empty($_GET['zona']) || !(empty($_GET['desde']) && empty($_GET['hasta'])) || !(empty($_GET['minimo']) && empty($_GET['maximo']))){
                    ...
                    //         // echo "entre a la metraje por V<br>";
                    ...
                    // }
                    $query.="AND inmueble = 'Departamento'";
                    $query2.="AND inmueble = 'Departamento'";
                    ...
                    if($numeroBusqueda != 0){
                        ...
                        while($i <= $numeroBusqueda){
                            $paso1 = $query2;
                            $query2 .= " AND ft.alquiler_id_alquiler = $contador";
                                ...
                                <br><br>
                                    <div class="row tiempo"  style="border-style: inset; border-color: burlywood; margin-left: 0;margin-right: 0;">
                                                ...
                                                <div class="carousel-inner" role="listbox">
                                                    ...
                                                    ?>
                                                        ...
                                                        <div style="background-color: white;" align="center" id="cajaFoto">
                                                            ...
                                                            <img src="<?php echo $mostrar['foto']?>" alt="Aqui va la imagen" height="100%">
                                                        </div>
                                        ...
                                        <div class="col-md-4" style=" background-color: white; opacity: 0.7; color: black; margin-top: 0;">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-3" style="float: none;">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <a class="boton" style="position: absolute;" href="https://api.whatsapp.com/send?phone=591<?=$mostrar['celular'];?>&text=hola,%20Estoy%20interesado%20en%20el%20inmueble,%20por%20favor%20podría%20ampliar%20algo%20mas%20de%20informacion...?">
                                            ...
                                            <button onClick='CopyToClipboard("to-copy<?php echo $i?>")' class="boton2">Copiar Link</button>
                ...
                ?>
                    <div style="background-color: white; border-radius: 25px; opacity: 0.8;">
                        <img src="../../img/inicio/sinAlquiler.png" alt="" width="100%">
                    </div>
                    <br>
                    <!-- <div class="alert alert-success alert-dismissible">
                        <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                        <strong>Lo sentimos!</strong> Indicates a successful or positive action.
                    </div> -->
                <?php
                    }
                }
                ...
                ?>
                    <div class="alert alert-warning alert-dismissible">
                        ...
                        <br>
                        <strong><i class="fa fa-frown-o fa-2x" aria-hidden="true"></i> Seleccione! o llene</strong> un campo al menos del formulario de FILTRO.
                    </div>
                <?php
                }
            }
                ...
                while($i <= $numero){
                    $consultaInterna = "SELECT * 
                                        FROM inmueble_alquiler iv INNER JOIN foto_alquiler ft
                                            ON (iv.id_alquiler = ft.alquiler_id_alquiler) INNER JOIN agente_venta av
                                                ON iv.agente_venta_id_agente_venta = av.id_agente_venta
                                        WHERE inmueble = 'Departamento' AND alquiler_id_alquiler = $contador";
                        ...
                        <div class="col-md-4" style=" background-color: white; opacity: 0.7; color: black; margin-top: 0;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3" style="float: none;">
                                    <div class="row">
                                        <div class="col-md-6" style="float: left;">
                                            <a href="<?php if($mostrar['youtube'] != null){echo $mostrar['youtube'];}else{echo "#";}?>" class="btn btn-success btl-lg boton1"><i class="fa fa-youtube-play" aria-hidden="true"></i> You Tube</a>                                            
                                        </div>
                                        <div class="col-md-6">
                                            <a class="boton" style="position: absolute;" href="https://api.whatsapp.com/send?phone=591<?=$mostrar['celular'];?>&text=Hola,%20Estoy%20interesado%20en%20el%20inmueble,%20por%20favor%20podría%20ampliar%20algo%20mas%20de%20informacion...?">
                                                <i class="fa fa-whatsapp" aria-hidden="true"></i> WhatsApp

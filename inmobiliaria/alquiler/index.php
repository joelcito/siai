...
<html>
    ...
    <body>
        <div class="container">
            ...
            <div class="row">
                    <div class="col-md-3"><a href="listaOficinas.php" class="boton">Oficina</a></div>
                    <div class="col-md-3"><a href="listaDepartamentos.php" class="boton">Departamento</a></div>
                    <div class="col-md-3"><a href="listaCasas.php" class="boton">Casa</a></div>
                    <div class="col-md-3"><a href="listaLocalComerciales.php" class="boton">Local Comercial</a></div>
            </div>
            <!-- <footer>
                <div class="row">

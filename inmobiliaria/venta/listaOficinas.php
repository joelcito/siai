...
<html>
    ...
    <style>
        ...
        <div id="panel">
        <!-- <div id="ventana-filtro" style="display:block;"> -->
            <div id="panel-admin">
            ...
            if(isset($_GET['buton'])){
                if(!empty($_GET['zona']) || !(empty($_GET['desde']) && empty($_GET['hasta'])) || !(empty($_GET['minimo']) && empty($_GET['maximo']))){
                    ...
                    if($numeroBusqueda != 0){
                        ...
                        while($i <= $numeroBusqueda){
                            $paso1 = $query2;
                            $query2 .= " AND ft.venta_id_venta = $contador";
                                                ...
                                                <div class="carousel-inner" role="listbox">
                                                    ...
                                                    ?>
                                                        ...
                                                        <div style="background-color: white;" align="center" id="cajaFoto">
                                                            ...
                                                            <img src="<?php echo $mostrar['foto'];?>" alt="" height="100%">
                                                        </div>
                ...
                ?>
                    <div style="background-color: white; border-radius: 25px; opacity: 0.8;">
                        <img src="../../img/inicio/sinVenta.png" alt="" width="100%">
                    </div>
                <?php
                    }
                }
                ...
                while($i <= $numero){
                    $consultaInterna = "SELECT * 
                                        FROM inmueble_venta iv INNER JOIN foto_venta ft
                                            ON (iv.id_venta = ft.venta_id_venta) INNER JOIN agente_venta av
                                                ON iv.agente_venta_id_agente_venta = av.id_agente_venta
                                        WHERE inmueble = 'Oficina' AND venta_id_venta = $contador";

<?php
    ...
    if (isset($_POST['registrar'])) {
        ...
        $consulta = "INSERT INTO inmueble_venta VALUES(NULL,'$id_agente_venta','$inmueble','$zona','$precio','$tipo_pago','$num_dormitorio','$num_baños','$num_bauleras','$matraje','$num_parqueos','$tipo','$garantia','$num_cocina','$lavanderia','$link_youtube','$rutapdf')";
        ...
        if(mysqli_query($conexion,$consulta)){
            ...
            $consulta = "";
            $consulta = "SELECT MAX(id_venta) as id
                        FROM inmueble_venta";
            if($consulta){
                ...
                foreach ($arreglo_fotos as $fotosID => $foto) {
                    ...
                    $consulta = "INSERT INTO foto_venta VALUES (NULL,'$id_inmueble','$ruta')";
                ...
                if(!empty($_FILES['archivo']['name'])){
                    ...
                    mysqli_query($conexion,"UPDATE inmueble_venta SET pdf = '$rutapdf' WHERE id_venta = '$id_inmueble'");
                }
                header("location: registrar_inmueble_venta.php?haber=Se registro con Exito!");
            }
        }
        else{
            echo "pero";

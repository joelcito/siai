                        ...
                        <!-- filtro de busqueda -->
                            <div class="row" >
                                <div class="col-md-12">
                                    ...
                                    ?>
                                        <label for="<?=$jul?>" class="form-control"><?=$mostrar['zona']?>  <input type="checkbox" name="zona[]" value="<?=$mostrar['zona']?>" id="<?=$jul?>" ></label>
                                    <?php
                                        $jul++;
                                    }
                                    ?>
                ...
                while($i <= $numero){
                    $consultaInterna = "SELECT * 
                                        FROM inmueble_venta iv INNER JOIN foto_venta ft
                                            ON (iv.id_venta = ft.venta_id_venta) INNER JOIN agente_venta av
                                                ON iv.agente_venta_id_agente_venta = av.id_agente_venta
                                        WHERE inmueble = 'Casa' AND venta_id_venta = $contador";

                                ...
                                <div class="col-md-12">
                                    ...
                                    <?php
                                        ...
                                        $consulta = "SELECT DISTINCT zona 
                                                    FROM inmueble_venta
                                                    WHERE inmueble = 'Local Comercial'";
        ...
        <div class="container">
            ...
            if(isset($_GET['buton'])){
                if(!empty($_GET['zona']) || !(empty($_GET['desde']) && empty($_GET['hasta'])) || !(empty($_GET['minimo']) && empty($_GET['maximo']))){
                    ...
                    // }
                    $query.="AND inmueble = 'Local Comercial'";
                    $query2.="AND inmueble = 'Local Comercial'";
                ...
                ?>
                    <div style="background-color: white; border-radius: 25px; opacity: 0.8;">
                        <img src="../../img/inicio/sinVenta.png" width="100%" alt="">
                    </div>
                <?php
                    }
                }
                ...
                while($i <= $numero){
                    $consultaInterna = "SELECT * 
                                        FROM inmueble_venta iv INNER JOIN foto_venta ft
                                            ON (iv.id_venta = ft.venta_id_venta) INNER JOIN agente_venta av
                                                ON iv.agente_venta_id_agente_venta = av.id_agente_venta
                                        WHERE inmueble = 'Local Comercial' AND venta_id_venta = $contador";

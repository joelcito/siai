    ...
    <style>
      ...
      <div id="panel">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <button class="open1"><a href="<?php if($inmueble == 'Torre lu'){echo "lista_torre_lu.php";}else if($inmueble == 'Bethesda'){echo "lista_bethesda.php";}else if($inmueble == 'Orabela'){echo "lista_orabela.php";}else{echo "lista_kyrios.php";}?>"><i class="fa fa-arrow-left" aria-hidden="true"></i></a></button>
                </div>
            </div>
        </div>
    <body id="">
            ...
            <?php
                ...
                // while($i <= $numero){
                    $consultaInterna = "SELECT * 
                                        ...
                                        WHERE inmueble = '$inmueble' AND inmueble_pre_venta_id_inmueble_pre_venta = $idimueble";

...
<html>
                            ...
                            <div class="col-md-12">
                                ...
                                <?php
                                    ...
                                    $consulta = "SELECT DISTINCT zona 
                                                ...
                                                WHERE inmueble = 'Torre lu'";
                                                // WHERE inmueble = 'Departamento'";
                                    $resultado = mysqli_query($conexion,$consulta);
                                    while($mostrar = mysqli_fetch_array($resultado)){
                                ?>
                                    <label for="z" class="form-control"><?=$mostrar['zona']?>  <input type="checkbox" name="zona[]" value="<?=$mostrar['zona']?>" id="z" required></label>
                                <?php
                                    }
                                ?>
                            </div>
    ...
    <body id="">
        <div class="container">
            ...
            if(isset($_GET['buton'])){
                $query2 = "SELECT *
                            FROM inmueble_pre_venta iv INNER JOIN foto_pre_venta ft
                                ON (iv.id_inmueble_pre_venta = ft.inmueble_pre_venta_id_inmueble_pre_venta) INNER JOIN agente_venta av
                ...
                $query .= " AND inmueble = 'Torre lu'";
                $query2 .= " AND inmueble = 'Torre lu'";
                ...
                if($numeroBusqueda != 0){
                    ...
                    while($i <= $numeroBusqueda){
                        $paso1 = $query2;
                        $query2 .= " AND ft.inmueble_pre_venta_id_inmueble_pre_venta = $contador";
                            ...
                            <br><br>
                                <div class="row tiempo"  style="border-style: inset; border-color: burlywood; margin-left: 0;margin-right: 0;">
                                    ...
                                    <div class="col-md-4" style=" background-color: white; opacity: 0.7; color: black; margin-top: 0;">
                                        <h2 style="color: black;"> <?php echo $mostrar['inmueble'];?> en Pre Venta</h2>
                                        <p>
                                            <h4>
                                        ...
                                        <div id="to-copy<?php echo $i?>" class="hidden">
                                            https://www.siai.com.bo/inmobiliaria/pre_venta/mostrar.php<?php echo "?id=".$mostrar['id_inmueble_pre_venta']."&"."inmueble=".$mostrar['inmueble'];?>
                                        </div>
            ...
            // $conexion = new mysqli("localhost","root","","mydb");
                $consulta = "SELECT * FROM inmueble_pre_venta
                            WHERE inmueble = 'Torre lu'";
                $resultado = mysqli_query($conexion,$consulta);
                ...
                while($i <= $numero){
                    $consultaInterna = "SELECT * 
                                        FROM inmueble_pre_venta iv INNER JOIN foto_pre_venta ft
                                            ON (iv.id_inmueble_pre_venta = ft.inmueble_pre_venta_id_inmueble_pre_venta) INNER JOIN agente_venta av
                                                ON iv.agente_venta_id_agente_venta = av.id_agente_venta
                                        WHERE inmueble = 'Torre lu' AND inmueble_pre_venta_id_inmueble_pre_venta = $contador";
